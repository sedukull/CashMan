...
public class CashManTests {
    ...
    public void testCashManWithDrawAmount40() throws CashNotAvailableException {
        ...
        Assert.assertEquals(denominationList.size(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 20).mapToInt(x->x.getDenominationCount()).sum(), 2);
    }
    ...
    public void testCashManWithDrawAmount50() throws CashNotAvailableException, IllegalArgumentException {
        ...
        Assert.assertEquals(denominationList.size(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 50).mapToInt(x->x.getDenominationCount()).sum(), 1);
    }
    ...
    public void testCashManWithDrawAmount60() throws CashNotAvailableException, IllegalArgumentException {
        ...
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 50).mapToInt(x->x.getDenominationCount()).sum(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 10).mapToInt(x->x.getDenominationCount()).sum(), 1);
    }
    ...
    public void testCashManWithDrawAmount80() throws CashNotAvailableException, IllegalArgumentException {
        ...
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 50).mapToInt(x->x.getDenominationCount()).sum(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 10).mapToInt(x->x.getDenominationCount()).sum(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 20).mapToInt(x->x.getDenominationCount()).sum(), 1);
    }
    ...
    public void testCashManWithDrawAmount100() throws IllegalArgumentException, CashNotAvailableException{
        ...
        Assert.assertEquals(denominationList.size(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 100).mapToInt(x->x.getDenominationCount()).sum(), 1);
    }
    ...
    public void testCashManWithDrawAmount200() throws IllegalArgumentException, CashNotAvailableException {
        ...
        Assert.assertEquals(denominationList.size(), 1);
        Assert.assertEquals(denominationList.stream().filter(x -> x.getDenominationType().getValue() == 100).mapToInt(x->x.getDenominationCount()).sum(), 2);
    }
